<?php
/**
 * LottoExpert.net — Florida Pick 6 (FL6) Results Intelligence Page
 * Joomla 5.x + PHP 8.1+
 *
 * GAME CONFIG:
 * - game_id     = FL6
 * - main balls  = 6  (positions: first, second, third, fourth, fifth, sixth)
 * - main range  = 01..46  (single shared pool — no separate bonus pool)
 * - no separate bonus / special number
 *
...
if (isset($stateName, $gName) && $stateName !== '' && $gName !== '') {
    ...
    $doc->setMetaData('description', 'Verified draw results, frequency analysis, and number behavior insights for ' . $stateName . ' ' . $gName . '. Review active numbers, quiet stretches, and full draw history on LottoExpert.net.');
}
...
/**
 * Finds main-ball numbers from the latest draw that also appeared
 * in recent trailing draws. Handles all 6 ball columns for FL6.
 */
...
/**
 * Returns the most recent draw date on which a given ball appeared
 * in any of the 6 positions (all are main balls for FL6).
 */
...
// All 6 balls belong to the same main pool for FL6
$latestMainBalls = array_values(array_filter([$p1, $p2, $p3, $p4, $p5, $pb], function ($v) {
    return $v !== '';
}));
 ...
 */
$rowsMain = leFetchRecentDraws($db, (string) $dbCol, $gameId, $nodCurrent);

[$mainCounts, $mainLastSeenIndex] = leInitRange(1, 46);
...
/**
 * ── Chart and insight data ───────────────────────────────────────────────────
 */
$mainChartLabels   = leBuildNaturalLabels(1, 46);
$mainChartValues   = [];
$mainRecencyValues = [];
...
[$counts50,  ] = leInitRange(1, 46);
[$counts300, ] = leInitRange(1, 46);
 ...
 * All 6 balls are main balls so we look up each across all 6 positions.
 */
$drawHistoryRows = [];
 ...
 */
$schemaName = (isset($stateName, $gName) && $stateName !== '' && $gName !== '')
    ? $stateName . ' ' . $gName . ' Results Intelligence | LottoExpert.net'
    : 'Lottery Results Intelligence | LottoExpert.net';

$schemaDesc = (isset($stateName, $gName) && $stateName !== '' && $gName !== '')
    ? 'Verified draw results, frequency analysis, and number behavior insights for ' . $stateName . ' ' . $gName . '. Analytical intelligence only on LottoExpert.net.'
    : 'Lottery results intelligence and frequency analysis on LottoExpert.net.';
...
$schemaJson = json_encode($schemaPage, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
...
<div class="skai-page">
    ...
    <div class="skai-hero-inner">
      <div class="skai-hero-top">
        ...
        <div class="skai-hero-copy">
          ...
          <!-- Latest draw: all 6 main balls from pool 01–46 -->
          ...
          <div class="skai-hero-actions" aria-label="Primary actions">
            <a class="skai-btn skai-btn--primary" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=FL6">
              Open SKAI Analysis
            </a>
            <a class="skai-btn skai-btn--secondary" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=FL6">
              AI Predictions
            </a>
          ...
          <div class="skai-advanced-links" aria-label="Advanced tools">
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=FL6">Skip &amp; Hit Analysis</a>
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=FL6">MCMC Markov Analysis</a>
            <a class="skai-mini-link" href="/all-lottery-heatmaps?gameId=FL6">Heatmap Analysis</a>
            ...
            <a class="skai-mini-link" href="/lowest-drawn-number-analysis?gId=<?php echo rawurlencode($gId); ?>&amp;stateName=<?php echo rawurlencode((string) ($stateName ?? '')); ?>&amp;gName=<?php echo rawurlencode((string) ($gName ?? '')); ?>&amp;sTn=<?php echo rawurlencode(strtolower((string) ($stateAbrev ?? ''))); ?>">Lowest Number Analysis</a>
          </div>
        </div>
        ...
        <aside class="skai-result-panel" aria-label="Latest draw details">
          ...
          <div class="skai-meta-stack">
            ...
            <div class="skai-meta-box">
              ...
              <span class="value">Recent activity, quiet stretches, and full number distribution within your selected analysis window.</span>
            </div>
  ...
  <section class="skai-strip" aria-label="Key takeaways">
    ...
    <article class="skai-stat">
      ...
      <div class="skai-stat-body">
        <div class="skai-stat-value"><?php echo (int) $nodCurrent; ?> draws</div>
        <div class="skai-stat-note">Draw window currently loaded for frequency, recency, and table analysis on this page view.</div>
      </div>
    </article>
  </section>
    ...
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Start with a clear high-level view. This layer is designed for fast orientation: which numbers are most active, which are quiet, and how the current draw relates to recent history. All six ball positions (01&ndash;46) are treated as a single pool.
        </p>
      </div>
    </div>
  ...
  <section id="recency-deep-dive" class="skai-section" aria-labelledby="recency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          This section makes the current draw easier to interpret. It shows how recently each of the six latest numbers was previously seen, and how the perspective shifts when comparing a short recent window with a broader historical one.
        </p>
      </div>
    </div>
  ...
  <section id="frequency-deep-dive" class="skai-section" aria-labelledby="frequency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Move from summary to full reference. The first panel shows the complete number distribution across all values 01&ndash;46 from the same shared pool. The second panel shows the recency distribution — how long ago each number last appeared within the current window.
        </p>
      </div>
    </div>
    ...
    <div class="skai-section-body">
      <div class="skai-two-col">
        ...
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--horizon">
            Full number distribution (01&ndash;46)
            <span class="skai-card-sub">All values across the last <?php echo (int) $nodCurrent; ?> drawings</span>
          </div>
          <div class="skai-card-body">
            <div class="skai-chart-shell">
      ...
      <div class="skai-note">
        The complete distribution is best used as a reference layer. The overview modules above are optimized for quick reading; this section is optimized for thorough review. All 46 numbers share a single pool — there are no separate bonus or special balls in this game.
      </div>
    </div>
  </section>
  ...
  <section id="tables" class="skai-section" aria-labelledby="tables-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Use the table for exact counts, recency, and personal tracking. Quick filters help narrow the view without losing full access to the complete dataset. Adjust the draw window below and submit to update all analysis on this page.
        </p>
      </div>
    </div>
      ...
      <form name="fqsearch" method="post" action="/all-us-lotteries/results-analysis?st=<?php echo htmlspecialchars((string) ($stateAbrev ?? ''), ENT_QUOTES, 'UTF-8'); ?>&amp;stn=<?php echo htmlspecialchars((string) ($stateName ?? ''), ENT_QUOTES, 'UTF-8'); ?>&amp;gm=<?php echo htmlspecialchars((string) ($gName ?? ''), ENT_QUOTES, 'UTF-8'); ?>#tables">
        <div class="skai-controls-row">
          <div class="skai-controls-left">
            <label for="nod">Draw window to analyze</label>
    ...
    <div class="skai-section-body">
      <div class="skai-card">
        <div class="skai-card-head skai-card-head--horizon">
          Number frequency table (01&ndash;46)
          <span class="skai-card-sub">Exact counts and recency for all values in the last <?php echo (int) $nodCurrent; ?> drawings</span>
        </div>
          ...
          <table id="skai-main-table" class="skai-table" aria-label="Number frequency table">
            ...
            <tbody>
              <?php for ($i = 1; $i <= 46; $i++) : ?>
                ...
                [$lastDrawSort, $lastDrawLabel] = leDrawingsAgoLabel($mainLastSeenIndex[$number] ?? null, (int) $nodCurrent);
  ...
  <section id="tools" class="skai-section" aria-labelledby="tools-title">
    ...
    <div class="skai-section-body">
      <div class="skai-tool-grid">
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=FL6">Open SKAI Analysis</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=FL6">Open AI Predictions</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=FL6">Open Skip &amp; Hit</a>
          </div>
        </article>
      ...
      <div class="skai-utility-grid">
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=FL6">MCMC Markov Analysis</a>
        <a class="skai-utility-link" href="/all-lottery-heatmaps?gameId=FL6">Heatmap Analysis</a>
  ...
  <section class="skai-section" aria-labelledby="method-title">
    ...
    <div class="skai-section-body">
      <div class="skai-method-note">
        <strong>Interpretation guidance:</strong> Frequency, recency, and spacing can provide useful context for reviewing draw history, but they should be treated as descriptive signals rather than guarantees. This page covers Florida Pick 6 (game ID: FL6), which draws six numbers from a single pool of 01&ndash;46. All analysis on this page reflects that single-pool structure. The purpose of this page is to make the recent behavior of the game easier to understand, compare, and carry into deeper SKAI analysis.
      </div>
    </div>
  </section>
